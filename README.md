...
| DuckDB 1.5.2 | `external/duckdb/` | 嵌入式 SQL 引擎（vendored） |
...
```
 CMakeLists.txt                      |  36 +++++++++--
 README.md                           |   6 +-
 include/tdx/data/adjust.hpp         |  13 +---
 include/tdx/data/resampler.hpp      |   2 +-
 include/tdx/proto/parsers.hpp       |   5 ++
 include/tdx/proto/vipdoc_reader.hpp |   3 +-
 include/tdx/query/duckdb_query.hpp  |  16 +++++
 include/tdx/quotes/std_quotes.hpp   |   3 +
 include/tdx/types.hpp               |  15 +++--
 src/CMakeLists.txt                  |   7 ++-
 src/cli/import.cpp                  | 384 ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 src/cli/main.cpp                    |  11 +++-
